...
for conf['batch_size'] in [64]:
     for i in range(3):
         for loss_type in ['SOAP']:
             ...
             bins = 2
             mv_gamma = 0.999
             out_path = './Released_results/{}/cifar100/SGD_results_{}_bth_{}_epoch_{}_lr_{}_ft_mode_{}_tau_{}_posNum_{}_threshold_{}_repeats_{}_imb_{}_surrloss_{}_gamma_{}'.format(model_name, loss_type,  conf['batch_size'], conf['epochs'], conf['lr'], conf['ft_mode'],tau, conf['posNum'], th, i, imb_ratio, conf['surr_loss'], str(mv_gamma))
